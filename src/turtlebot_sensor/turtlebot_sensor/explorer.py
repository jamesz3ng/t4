...
class FrontierExplorer(Node):
    def __init__(self):
        ...
        self.declare_parameter('step_distance', 2.0) # Default initial step distance
        self.declare_parameter('min_sweep_step_distance', 1.25)
        self.declare_parameter('sweep_step_reduction_factor', 2)
